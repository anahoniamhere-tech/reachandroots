       ...
       <div className="relative z-10 flex gap-1.5 md:gap-4 text-center shrink-0" dir="ltr">
          {[
            ...
            <div key={i} className="flex flex-col items-center">
               ...
               <span className={`text-white/50 uppercase ${isRTL ? 'font-arabic tracking-normal text-[10px] md:text-xs' : 'font-mono tracking-widest text-[7px] md:text-[10px]'}`}>{item.label}</span>
            </div>
          ))}
       </div>
    </div>
