  ...
  en: {
    ...
    story: {
      ...
      companyInfo: {
        ...
        mission: {
          ...
          desc: 'Our mission is to create spaces where creators and storytellers can meet, exchange experiences, develop their ideas, and bring their voices to wider audiences. We believe creativity grows in healthy environments built on collaboration, learning, and shared value.',
    ...
    sanctuary: {
      ...
      journey: {
        ...
        wishDesc: 'Transfer the amount to the Whish Money account below. Please include your wanted ticket and workshop titles in the transfer description. Keep your transaction receipt to present it at the entrance.',
    ...
    registration: {
      ...
      subtitle: 'Become part of the Roots & Reach network',
      fullName: 'Full Name',
      phone: 'Phone / WhatsApp',
      email: 'Email',
      age: 'Age',
      ...
      countryOfResidenceHint: '(We use this info for local announcements and related events)',
      ...
      topicOfInterest: 'What areas of interest are you most passionate about?',
      knowMore: 'Would you like to receive updates about upcoming community meetups, workshops, and programs?',
      consent: 'Consent',
  ...
  ar: {
    ...
    story: {
      ...
      companyInfo: {
        ...
        mission: {
          ...
          desc: 'مهمتنا خلق مساحات يلتقي فيها صُنّاع المحتوى ورواة القصص، لتبادل الخبرات، تطوير الأفكار، وإيصال الأصوات إلى جمهور أوسع. نؤمن أن الإبداع ينمو في بيئة صحية قائمة على التعاون، التعلّم، والاستفادة المشتركة.',
          pillars: { p1: 'نربط', p2: 'نشارك', p3: 'نتعاون', p4: 'ننمو' }
        }
      },
      location: {
        title: 'الموقع.',
    ...
    sanctuary: {
      ...
      journey: {
        ...
        ws1Loc: 'بيت الفن، طرابلس',
        ws1Date: 'الأربعاء، 8 تموز / يوليو 2026',
        ws1Time: 'من الساعة 4:30 عصراً حتى 7:30 مساءً',
        ...
        ws2Loc: 'بيت الفن، طرابلس',
        ws2Date: 'الخميس، 9 تموز / يوليو 2026',
        ws2Time: 'من الساعة 4:30 عصراً حتى 7:30 مساءً',
        ...
        wishTitle: 'تحويل عبر Whish Money',
        wishDesc: 'يمكنك إرسال قيمة التذكرة عبر تطبيق Whish Money إلى الحساب أدناه. يرجى كتابة نوع التذكرة وعناوين الورش المطلوبة في ملاحظات التحويل، والاحتفاظ بصورة التحويل لإبرازها عند الباب.',
    ...
    registration: {
      ...
      subtitle: 'كن جزءاً من شبكة Roots & Reach',
      ...
      countryOfResidenceHint: '(نستخدم هذه المعلومات للإعلانات والفعاليات المحلية)',
      role: 'كيف تصف نفسك؟',
      ...
      topicOfInterest: 'ما هي مجالات الاهتمام التي تثير شغفك؟',
      knowMore: 'هل تود/ين تلقي تحديثات حول اللقاءات والورش والبرامج القادمة للمجتمع؟',
      consent: 'الموافقة',
      consentLabel: 'أوافق على الشروط والأحكام.',
      submit: 'انضم الآن',
      submitting: 'جاري الانضمام...',
      successTitle: 'أهلاً بك في مجتمعنا!',
      successDesc: 'شكراً لانضمامك إلى مجتمعنا! سنبقيك على اطلاع باللقاءات والفرص القادمة.',
