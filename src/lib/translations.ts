    ...
    story: {
      ...
      companyInfo: {
        ...
        mission: {
          ...
          desc: 'همتنا خلق مساحات يلتقي فيها صُنّاع المحتوى ورواة القصص، لتبادل الخبرات، تطوير الأفكار، وإيصال الأصوات إلى جمهور أوسع. نؤمن أن الإبداع ينمو في بيئة صحية قائمة على التعاون، التعلّم، والاستفادة المشتركة.',
